...
<div class="card-styles">
    <div class="card-style-3 mb-30">
        <div class="card-content">
            ...
            <form action="{{ route('about.teamStore') }}" enctype="multipart/form-data" method="POST">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="input-style-1">
                            ...
                            <input @error('phone') class="form-control is-invalid" @enderror type="tel" name="phone"
                                id="phone" placeholder="{{ __('Phone') }}" value="{{ old('phone')}}" required>
                            @error('phone')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
